...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Azza Indonesia Supplier</title>
    ...
    <body class="antialiased overflow-x-hidden" style="overflow-x: hidden;">
                        ...
                        <div class="carousel-item {{ $key == 0 ? 'active' : '' }}" data-bs-interval="10000">
                            <div class="container ">
                                <div class="row d-flex align-items-start">
                                    <div class="col-md-6">
                                        <h1 class="text-start fw-bold text-center text-md-start" style="font-size:32px;">Our Products</h1>
                                        <h3 class="fw-bold mt-3 text-center text-md-start" style="color:#82954B; font-size:22px;">{{$product->title}}</h3>
                                        ...
                                        <div class="col-md-4 benner-button bg-green mt-3 text-center mx-auto ms-md-0 ">
                                    ...
                                    <div class="col-md-6">
                                        <img src="{{$product->image}}" alt="" class="w-100 mt-3 mt-md-0" style="border-radius:10%;">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        {{-- <section class="container" style="margin-top:150px;" data-aos="fade-down" data-aos-duration="1000" data-aos-easing="linear">
            ...
            <div class="col-md-4">
                <div class="d-flex justify-content-center align-items-center flex-column mt-4">
                    <img src="{{$user->image}}" alt="" class="img-fluid w-50">
                    <h5 class="text-dark mt-2" style="">{{$user->name}}</h5>
                    <h6 class="fw-bold" style="color:#82954B;">{{$user->work}}</h6>
                </div>
            </div>
            @endforeach
        ...
        <section class="container-fluid py-5 " style="margin-top:150px; background-color:rgba(130, 149, 75, 0.9);  ">
            ...
            <div class="row d-flex justify-content-center mt-1 g-5">
                ...
                <img src="{{$sponsor->image}}" alt="" class="w-50">
                <h5 class="fw-bold mt-3 text-white">{{$sponsor->title}}</h5>
                </div>
                @endforeach
        ...
        <div class="button-kontak-wrapper d-none d-md-block">
            <div class="button-item-kontak-wrapper wa-icon">
                <a href="https://wa.link/jqwsm0" class="pulse">
        ...
        <section id="contact">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
                    ...
                    <div class="text-white fs-1"style="font-family: 'Passion One', cursive;">{{$settings->logo}}</div>
                    <div class="text-white w-75 d-none d-md-block">
                        {{$settings->tagline_3}}
                    </div>
                    <div class="text-white w-100 d-block d-md-none" >
                        {{$settings->tagline_3}}
                    </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="fw-bold mt-3 d-flex align-items-center gap-2">
                        ...
                        <a href="{{$settings->instagram}}" class="text-decoration-none text-white" >Instagram</a>
                    </div>
                    <div class="fw-bold mt-3 d-flex align-items-center gap-2">
                        ...
                        <a href="{{$settings->facebook}}" class="text-decoration-none text-white ">Facebook</a>
                    </div>
                    ...
                    <div class="fw-bold mt-3 d-flex align-items-center gap-2">
                        ...
                        <a href="{{$settings->linkedin}}" class="text-decoration-none text-white">Linkendin</a>
                    </div>
                    <div class="fw-bold mt-3 d-flex align-items-center gap-2">
                        ...
                        <a href="{{$settings->youtube}}" class="text-decoration-none text-white">Youtube</a>
                    </div>
                    </div>
                </div>
                <div class="col-md-3 mt-4 mt-md-0">
                    ...
                    <span class="fs-4 text-white fw-bold">Address</span>
                        <div class="mt-3 d-flex align-items-center gap-2 justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#fff" class="bi bi-geo-alt fw-bold" viewBox="0 0 16 16">
                                <path d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A31.493 31.493 0 0 1 8 14.58a31.481 31.481 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94zM8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10z"/>
                                <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                            </svg>
                            <span class="text-white fw-bold"> {{$settings->address}} </span>
                        </div>
                        <div class="mt-3 d-flex align-items-center gap-2">
                            ...
                            <span class="text-white fw-bold">{{$settings->email}}</span>
                        </div>
                        ...
                        <div class="mt-3 d-flex align-items-center gap-2">
                            ...
                            <span class="text-white fw-bold">{{$settings->phone_number}}</span>
